...
class API {
  ...
  createComment(movieId, comment) {
    return this._load({
      ...
      method: `POST`,
      body: JSON.stringify(_models_movie_js__WEBPACK_IMPORTED_MODULE_0__["default"].toLocalComment(comment)),
      headers: new Headers({'Content-Type': `application/json`})
    })
      .then((response) => response.json())
      .then((response) => {
        const movie = _models_movie_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseMovie(response.movie);
        movie.comments = _models_movie_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseComments(response.comments);
        return movie;
      });
  }
...
const createCardTemplate = (card) => {
  ...
  const runtimeText = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getRuntimeText"])(runtime);
...
const createCommentsMarkup = (comments) =>
  comments
    .map((comment) => {
      const dateString = moment__WEBPACK_IMPORTED_MODULE_0___default()(comment.date).format(`YYYY/MM/DD HH:mm`);
      const emojiSrc = `images/emoji/${comment.emoji}.png`;
      const sanitizedMessage = he__WEBPACK_IMPORTED_MODULE_1___default.a.encode(comment.message);
      return `\
...
const createFilmDetailsTemplate = (card, options = {}) => {
  ...
  const releaseDateString = moment__WEBPACK_IMPORTED_MODULE_0___default()(releaseDate).format(`DD MMMM YYYY`);
  ...
  const runtimeText = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["getRuntimeText"])(runtime);
...
class FilmDetails extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
...
/* harmony default export */ __webpack_exports__["default"] = (FilmDetails);
...
/***/ "./src/components/main-sorting.js":
/*!****************************************!*\
  !*** ./src/components/main-sorting.js ***!
  \****************************************/
/*! exports provided: default */
...
class MainSorting extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
...
/* harmony default export */ __webpack_exports__["default"] = (MainSorting);
...
/* harmony default export */ __webpack_exports__["default"] = (NoCards);
...
const createProfileHeaderTemplate = (watchedAmount) => {
  const rank = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getRank"])(watchedAmount);
...
class ProfileHeader extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
/* harmony default export */ __webpack_exports__["default"] = (ShowMoreButton);
...
/* harmony import */ var chart_js_dist_Chart_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! chart.js/dist/Chart.css */ "./node_modules/chart.js/dist/Chart.css");
/* harmony import */ var chart_js_dist_Chart_css__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(chart_js_dist_Chart_css__WEBPACK_IMPORTED_MODULE_2__);
...
const createStatisticsTemplate = (moviesModel, mode) => {
  ...
  const rank = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_4__["getRank"])(Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_4__["getCategoryFilmsAmount"])(moviesModel.getMoviesAll(), `isWatched`));
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_main_menu_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/main-menu.js */ "./src/components/main-menu.js");
...
class MainMenuController {
  ...
  render() {
    ...
    const filters = FILTER_NAMES.map((filterType) => ({
      name: filterType,
      count: Object(_utils_filter_js__WEBPACK_IMPORTED_MODULE_2__["getMoviesByFilter"])(allMovies, filterType).length,
      active: filterType === this._activeFilterType
    }));
    const oldComponent = this._mainMenuComponent;

    this._mainMenuComponent = new _components_main_menu_js__WEBPACK_IMPORTED_MODULE_0__["default"](filters);
    ...
    if (oldComponent) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["replace"])(this._mainMenuComponent, oldComponent);
    } else {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(container, this._mainMenuComponent);
    }
  }
...
/* harmony default export */ __webpack_exports__["default"] = (MainMenuController);
...
class MovieController {
  ...
  render(movie) {
    ...
    this._cardComponent = new _components_card_js__WEBPACK_IMPORTED_MODULE_0__["default"](movie);
    this._filmDetailsComponent = new _components_film_details_js__WEBPACK_IMPORTED_MODULE_1__["default"](movie, oldFilmDetailsComponent ? oldFilmDetailsComponent.getCurrentEmoji() : null);
    ...
    if (oldCardComponent && oldFilmDetailsComponent) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._cardComponent, oldCardComponent);
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._filmDetailsComponent, oldFilmDetailsComponent);
    } else {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["render"])(this._container, this._cardComponent);
    }
  }
  ...
  _showDetails() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["render"])(document.body, this._filmDetailsComponent);
...
/* harmony default export */ __webpack_exports__["default"] = (MovieController);
...
/* harmony import */ var _components_show_more_button__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/show-more-button */ "./src/components/show-more-button.js");
/* harmony import */ var _components_no_cards__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/no-cards */ "./src/components/no-cards.js");
/* harmony import */ var _utils_common_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/common.js */ "./src/utils/common.js");
...
const renderMovies = (container, movies, onDataChange, onViewChange, api) =>
  movies.map((movie) => {
    const movieController = new _movie_js__WEBPACK_IMPORTED_MODULE_0__["default"](container, onDataChange, onViewChange, api);
...
class PageController {
  constructor(container, sortingComponent, moviesModel, profileHeaderComponent, api) {
    ...
    this._noCardsComponent = new _components_no_cards__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._showMoreButtonComponent = new _components_show_more_button__WEBPACK_IMPORTED_MODULE_1__["default"]();
  ...
  render() {
    ...
    if (movies.length === 0) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["render"])(filmsListAllElement, this._noCardsComponent);
      return;
    }
  ...
  _renderExtraMovies() {
    ...
    let tempMovies = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["shuffle"])(movies);
    ...
    tempMovies = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["shuffle"])(movies);
  ...
  _renderShowMoreButton(sortedMovies) {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["remove"])(this._showMoreButtonComponent);
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["render"])(filmsListAllElement, this._showMoreButtonComponent);
        ...
        this._api.updateMovie(oldData.id, newData)
          .then((movieModel) => {
            ...
            if (isSuccess) {
              ...
              const watchedMoviesAmount = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["getCategoryFilmsAmount"])(movies, `isWatched`);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_profile_header_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/profile-header.js */ "./src/components/profile-header.js");
/* harmony import */ var _components_main_sorting_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/main-sorting.js */ "./src/components/main-sorting.js");
/* harmony import */ var _components_loading_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/loading.js */ "./src/components/loading.js");
...
/* harmony import */ var _controllers_main_menu_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./controllers/main-menu.js */ "./src/controllers/main-menu.js");
/* harmony import */ var _models_movies_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./models/movies.js */ "./src/models/movies.js");
...
const moviesModel = new _models_movies_js__WEBPACK_IMPORTED_MODULE_7__["default"]();

const siteHeaderElement = document.querySelector(`.header`);
const profileHeaderComponent = new _components_profile_header_js__WEBPACK_IMPORTED_MODULE_0__["default"](0);
const statisticsComponent = new _components_statistics_js__WEBPACK_IMPORTED_MODULE_4__["default"](moviesModel);
const mainSortingComponent = new _components_main_sorting_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
const loadingComponent = new _components_loading_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
const filmsComponent = new _components_films_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
const pageController = new _controllers_page_js__WEBPACK_IMPORTED_MODULE_5__["default"](filmsComponent, mainSortingComponent, moviesModel, profileHeaderComponent, api);

const siteMainElement = document.querySelector(`.main`);
const mainMenuController = new _controllers_main_menu_js__WEBPACK_IMPORTED_MODULE_6__["default"](siteMainElement, moviesModel, statisticsComponent, pageController);

Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_9__["render"])(siteHeaderElement, profileHeaderComponent);
mainMenuController.render();
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_9__["render"])(siteMainElement, mainSortingComponent);
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_9__["render"])(siteMainElement, loadingComponent);
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_9__["render"])(siteMainElement, statisticsComponent);
...
api.getMovies()
  .then((movies) => {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_9__["remove"])(loadingComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_9__["render"])(siteMainElement, filmsComponent);
    pageController.render();

    footerStatisticsParagraphElement.textContent = `${movies.length} movies inside`;
    const watchedMoviesAmount = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_10__["getCategoryFilmsAmount"])(movies, `isWatched`);
...
class Movies {
  ...
  getMovies() {
    return Object(_utils_filter_js__WEBPACK_IMPORTED_MODULE_0__["getMoviesByFilter"])(this._movies, this._activeFilterType);
  }
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: getRandomBoolean, getRandomIntegerNumber, getRandomArrayItem, shuffle, getCategoryFilmsAmount, castTimeFormat, getRank, getRuntimeText */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getCategoryFilmsAmount", function() { return getCategoryFilmsAmount; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getRuntimeText", function() { return getRuntimeText; });
...
/*!*****************************!*\
  !*** ./src/utils/filter.js ***!
  \*****************************/
/*! exports provided: getMoviesByFilter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
